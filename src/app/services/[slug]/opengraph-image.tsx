    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span style={{ fontFamily: "monospace", fontSize: 24, color: "#B9A3FF" }}>[DG] DevWorks</span>
        </div>
        <div style={{ display: "flex", marginTop: 40, fontSize: 52, fontWeight: 600, lineHeight: 1.15 }}>
          {title}
        </div>
        {priceLabel && (
          <div style={{ display: "flex", marginTop: 24, fontSize: 32, fontFamily: "monospace", color: "#B9A3FF" }}>
            {priceLabel}
          </div>
        )}
      </div>
